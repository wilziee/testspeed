...
function calculateStatus(dl) {
    if (dl >= 50) return { text: "🟢 Excellent", raw: "Excellent" };
    if (dl >= 20) return { text: "🟡 Good", raw: "Good" };
    if (dl >= 5) return { text: "🟠 Average", raw: "Average" };
    if (dl >= 1) return { text: "🔴 Slow", raw: "Slow" };
